...
$$W = m \cdot g = 50\,000 \times 9{,}81 = 490\,500 \text{ N}$$

### Passo 2 — Nuovo $C_L$ richiesto

Densità e velocità invariate, cambia solo $W$:

$$C_L = \dfrac{2W}{\rho V^2 S} = \dfrac{2 \times 490\,500}{0{,}381 \times 230^2 \times 122{,}6}$$
...
$$\boxed{C_L \approx 0{,}40}$$

### Confronto con peso base (70 000 kg)

| Peso | $W$ (N) | $C_L$ | Variazione |
|---|---|---|---|
| 70 000 kg (base) | 686 700 | 0,55 | — |
| 50 000 kg (variante) | 490 500 | 0,40 | **−27,3%** |
| Rapporto | 0,714 | 0,727 | $C_L \propto W$ ✅ |

**Lettura**: $C_L$ è proporzionale a $W$ (a parità di tutto il resto). Riduci il peso del 28,6%, riduci $C_L$ del 27,3% (coerente entro arrotondamenti).

### Implicazione operativa: lo "step climb"

Con $C_L = 0{,}40$, il jet è abbondantemente sotto $C_L^* \approx 0{,}82$ (vedi [Esercizio 10](../10-avanzato-polare-completa.md)). È più lontano dall'efficienza massima.

**Soluzione operativa dei piloti commerciali**: salire di quota man mano che il peso scende. A FL370 o FL390:

- $\rho$ scende ulteriormente → $C_L$ richiesto risale verso $C_L^*$

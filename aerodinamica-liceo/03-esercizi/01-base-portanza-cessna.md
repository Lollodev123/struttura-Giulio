...
1. **Cosa mi sta chiedendo?** Il coefficiente di portanza $C_L$ in una specifica condizione di volo.
...
$$W = m \cdot g = 1\,043 \text{ kg} \times 9{,}81 \, \frac{\text{m}}{\text{s}^2} = 10\,231{,}83 \text{ N}$$
...
### Passo 4 — Isolare $C_L$ dalla formula della portanza

Partendo da $L = \frac{1}{2}\rho V^2 S C_L$, isolo $C_L$:

$$C_L = \frac{2 L}{\rho V^2 S}$$

### Passo 5 — Sostituire i valori numerici

$$C_L = \frac{2 \times 10\,231{,}83}{1{,}225 \times (62{,}76)^2 \times 16{,}2}$$
...
> Crociera, velivolo GA: $C_L$ tipico = **0,2 – 0,4**

Il nostro $C_L \approx 0{,}26$ rientra **perfettamente** in questo intervallo, posizionandosi sul lato basso — coerente con una velocità di crociera relativamente alta (122 kt è la crociera standard del Cessna 172).

**Lettura fisica**: l'ala lavora "tranquilla", lontana dallo stallo (che avverrebbe intorno a $C_{L,max} \approx 1{,}5$). C'è ampio margine per manovre e per rallentare in atterraggio. ✈️
...
$C_L \approx 0{,}199 \approx 0{,}20$

> Più velocità ⇒ meno $C_L$ serve per generare lo stesso peso. Conferma: a velocità maggiori, l'ala "lavora meno". Per i dettagli del calcolo, vedi [`soluzioni/01-soluzione.md`](./soluzioni/01-soluzione.md).
...
- A parità di velivolo: **più veloce → $C_L$ minore**, perché la portanza cresce con $V^2$ e basta meno "aiuto" dall'angolo di attacco.
- Il **controllo delle unità** è metà del lavoro: 122 kt sostituiti come "122" dentro la formula avrebbero dato un $C_L$ assurdo (~70).

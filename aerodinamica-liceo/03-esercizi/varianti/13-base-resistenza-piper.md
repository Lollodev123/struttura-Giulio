...
> 🟢 **Difficoltà: BASE** — Variante dell'[Esercizio 3](../03-base-resistenza-atr.md): stessa metodologia (decomposizione $C_D = C_{D,0} + C_{D,i}$), ma su un velivolo di aviazione generale invece di un turboelica regionale.
>
...
- Resistenza parassita: $C_{D,0} = 0{,}033$ (un po' alta, è un velivolo poco aerodinamico)
- Fattore di Oswald: $e = 0{,}80$

**Determina**:
1. $C_L$ in crociera
2. $C_{D,i}$ (resistenza indotta)
3. $C_D$ totale
4. $D$ in newton
...
In crociera livellata: $L = W$ e $T = D$. La spinta del motore eguaglia la resistenza totale.
...
2. Calcola $C_L = W/(qS)$
3. Calcola $C_{D,i} = C_L^2 / (\pi \lambda e)$
4. Somma $C_D = C_{D,0} + C_{D,i}$
5. Calcola $D = q \cdot S \cdot C_D$
...
$$W = 1\,000 \times 9{,}81 = 9\,810 \text{ N}$$
$$q = \dfrac{1}{2} \times 1{,}225 \times 59{,}67^2 = \dfrac{1}{2} \times 1{,}225 \times 3\,560{,}5 = 2\,180{,}8 \text{ Pa}$$

### Passo 2 — Coefficiente di portanza

$$C_L = \dfrac{W}{q \cdot S} = \dfrac{9\,810}{2\,180{,}8 \times 15{,}8} = \dfrac{9\,810}{34\,457} \approx 0{,}285$$

### Passo 3 — Resistenza indotta

$$C_{D,i} = \dfrac{C_L^2}{\pi \lambda e} = \dfrac{0{,}285^2}{\pi \times 7{,}6 \times 0{,}80} = \dfrac{0{,}0812}{19{,}10} \approx 0{,}00425$$

$$\boxed{C_{D,i} \approx 0{,}0043}$$

### Passo 4 — Resistenza totale

$$C_D = C_{D,0} + C_{D,i} = 0{,}033 + 0{,}00425 = 0{,}0373$$

→ **Parassita pesa l'88,6%, indotta solo l'11,4%** in crociera. Tipico GA.

### Passo 5 — Resistenza in newton

$$D = q \cdot S \cdot C_D = 2\,180{,}8 \times 15{,}8 \times 0{,}0373 = 1\,285 \text{ N}$$
...
$$E = \dfrac{C_L}{C_D} = \dfrac{0{,}285}{0{,}0373} \approx 7{,}6$$
...
Stesso Piper, ma il pilota installa **gambali aerodinamici sulle ruote** (carenature che riducono la resistenza). Nuovo $C_{D,0} = 0{,}028$ invece di 0,033. **Calcola la nuova potenza richiesta**.

<details markdown="1">
<summary>👉 Solo il risultato (prima provaci da solo!)</summary>

$C_D$ nuovo = $0{,}028 + 0{,}0043 = 0{,}0323$
...
- $E_{Piper} \approx 7{,}6$ è sotto l'ATR ($E \approx 16{,}5$) perché ha $\lambda$ minore e $C_{D,0}$ maggiore.

...
>
> 🎯 **Obiettivi**: capire come la curvatura del profilo (parametro M) sposta la curva $C_p$–α, e confrontare un profilo a 5 cifre (Bonanza) con uno a 4 cifre molto curvo.
...
- **Profilo A**: NACA 23012 (5 cifre, ala del **Beechcraft Bonanza**). Angolo di portanza nulla $\alpha_0 = -1{,}2°$. $C_{p,max} = 1{,}65$ a $\alpha_{stallo} = 18°$.
- **Profilo B**: NACA 4412 (4 cifre, **molto curvato**). Angolo di portanza nulla $\alpha_0 = -4°$. $C_{p,max} = 1{,}55$ a $\alpha_{stallo} = 14°$.
- Pendenza $a = 0{,}11$/° per entrambi.

**Determina**:

1. $C_p$ per ciascun profilo a $\alpha = 0°, 4°, 8°$
2. $\alpha$ richiesto per generare $C_p = 1{,}0$ in approccio
...
Stessa formula dell'Esercizio 6: $C_p = a(\alpha - \alpha_0)$ in regime lineare.
...
$$C_p^A = 0{,}11 \times (\alpha - (-1{,}2°)) = 0{,}11 \times (\alpha + 1{,}2°)$$

**Profilo B (NACA 4412)**:
$$C_p^B = 0{,}11 \times (\alpha - (-4°)) = 0{,}11 \times (\alpha + 4°)$$

### Passo 2 — Tabulazione

| $\alpha$ | $C_p^A$ (23012) | $C_p^B$ (4412) | Differenza B−A |
|---|---|---|---|
...
### Passo 3 — α per $C_p = 1{,}0$ (approccio)
...
|---|---|---|
| $\alpha$ per $C_p = 1{,}0$ | 7,89° | **5,09°** (~3° in meno) |
| $C_{p,max}$ | **1,65** (più alto) | 1,55 |
| Margine al stallo (a $C_p = 1$) | 18 - 7,89 = **10,1°** | 14 - 5,09 = 8,9° |
| Profilo a 5 cifre? | sì | no |

**Lettura**: il **NACA 4412** "parte avanti" (genera già $C_p = 0{,}44$ a $\alpha = 0°$ contro 0,13 del 23012), però ha $C_{p,max}$ inferiore e stalla prima.

Il **NACA 23012** del Bonanza ha:

- Curvatura minore → meno portanza a basse α
- MA $C_{p,max}$ più alto → atterra meglio
- E $\alpha_{stallo}$ più alto → margine sicurezza maggiore
- I profili 5-cifre sono "ottimizzati" per $C_p$ specifici, non solo pendenza

**Per il Bonanza** (velivolo da turismo veloce, missione = crociera economica + atterraggi sicuri), il **NACA 23012 è la scelta giusta**: alta $C_{p,max}$ per atterraggi, basso $\alpha_0$ per cabin attitude moderato in crociera.
...
Stesso confronto, ma per generare $C_p = 0{,}3$ (alta velocità di crociera). Quale profilo richiede $\alpha$ minore?
...
- I **profili 5-cifre** (NACA 23012, 23016) sono ottimizzati per $C_p$ specifici → migliore stallo + alta $C_{p,max}$.
- I **profili 4-cifre molto curvati** (4412, 6412) hanno alto $C_p$ a basso α MA stallo precoce e cabin attitude problematico in crociera veloce.
